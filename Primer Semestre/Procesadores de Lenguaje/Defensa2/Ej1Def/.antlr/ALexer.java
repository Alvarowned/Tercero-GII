// Generated from c:\Users\alvar\OneDrive\Escritorio\Procesadores de Lenguaje\Defensa2\Ej1Def\ALexer.g4 by ANTLR 4.7.1
...
public class ALexer extends Lexer {
	...
	public static final String[] ruleNames = {
		"COMENTARIO_LINEA", "COMENTARIO_BLOQUE", "PUNTO_COMA", "DOS_PUNTOS", "COMA", 
		"ASIGNAR", "FUNCTION", "MAIN", "WHILE", "IF", "FOR", "PI", "PD", "SUMA", 
		"RESTA", "INCREMENTO", "DECREMENTO", "MULTIPLICACION", "DIVISION", "MAYOR_QUE", 
		"MENOR_QUE", "IGUAL", "AND", "OR", "BEGIN", "END", "INCLUDE", "VOID", 
		"PR_CADENA", "PR_NUMERO", "INT", "PUNTO", "NUMERO", "COMILLAS", "STRING", 
		"LETRA", "PALABRA", "SOBRAS"
	};
